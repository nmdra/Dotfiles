...
require('fzf-lua').setup({
  ...
  files = {
    ...
    fd_opts           = "--color=never --type f --hidden --follow --exclude .themes --exclude .librewolf --exclude .icons --exclude .cache --exclude .local --exclude .git --exclude *.mkv --exclude *.mp3 --exclude *.jpg --exclude *.png --exclude *.webp --exclude *.pdf",
    actions = {
